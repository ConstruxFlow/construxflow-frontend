    ...
    <div className="bg-purewhite min-h-screen">
      ...
      <div className="max-w-full mx-auto px-10 py-6">
        ...
        <div className="bg-web_yellow  text-black rounded-lg flex items-center px-4 py-3 mb-8">
          <span className="font-medium mr-2 text-gray-800">⚠ 3 new material requests require your attention</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-12">
          <div className="bg-purewhite rounded-lg p-5 shadow-md transition-transform duration-300 ease-in-out hover:shadow-lg hover:-translate-y-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          <div className="bg-purewhite rounded-lg p-5 shadow-md min-h-[230px]">
        ...
        <div className="bg-gray-900 rounded-lg p-5 mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <button className="flex flex-col items-center justify-center bg-purewhite text-main_dark px-6 py-5 rounded font-semibold shadow hover:brightness-95 transition">

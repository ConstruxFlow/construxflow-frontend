...
const RequestAdvancePayment = () => {
  ...
  console.log("he", quotationData?.supplierId);

  useEffect(() => {
    const fetchSupplier = async () => {
      const supplierResponse = await fetch(
        `http://localhost:8080/api/supplier/find/${quotationData?.supplierId}`,
        {
          method: "GET",
          headers: {
      ...
      // console.log(supplierResponseData);
    };
    ...
    try {
      ...
      const submitData = {
        ...
        order_payment: {
          ...
          bank_details: "Account: " + supplierData?.bank_account_number + ", Bank: " + supplierData?.bank_name,
        },
      };
      ...
      const response = await fetch(
        "http://localhost:8080/api/purchasingorder/create",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
              ...
              <div className="bg-purewhite border border-gray-200 rounded-lg p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Fill in the required information for your advance payment
                    </p>
                  </div>
                </div>
                ...
                <div className="mt-6">
                  ...
                  >
                    ...
                    <option value="Urgent Procurement">
                      Urgent Procurement
                    </option>
                    <option value="Cash Flow Management">
                ...
                <div className="space-y-4">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium text-main_dark">
                      RS{" "}
                      {parseFloat(paymentRequest.totalOrderValue || 0).toFixed(
                        2
                      )}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium text-main_dark">
                      RS{" "}
                      {parseFloat(paymentRequest.requestedAmount || 0).toFixed(
                        2
                      )}
                    </span>
                  </div>

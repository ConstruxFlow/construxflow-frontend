...
const PurchaseOrdersOverview = () => {
  ...
  useEffect(() => {
    filterOrders();
  }, [purchaseOrders, searchTerm, selectedStatus, selectedSupplier, selectedPaymentStatus]);
  ...
  const filterOrders = () => {
    let filtered = purchaseOrders.filter(order => {
      ...
      return matchesSearch && matchesStatus && matchesSupplier && matchesPaymentStatus;
    });
  ...
  const statuses = ['All Status', 'Pending', 'Approved', 'Completed', 'Cancelled'];
  const paymentStatuses = ['All Payment Status', 'Pending', 'Paid', 'Partial', 'Overdue'];
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6 gap-4">
            <div>
              ...
              <p className="text-gray-600 text-sm sm:text-base">
                View and manage all purchase orders across suppliers
              </p>
            </div>
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <button onClick={() => navigate('/purchasing/orders/create')} className="px-4 py-2 bg-web_yellow text-main_dark rounded-md hover:bg-web_yellow/90 transition-colors flex items-center justify-center gap-2 text-sm font-semibold">
                  ...
                  <div className="flex justify-between items-start mb-3">
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <span className="font-semibold text-main_dark text-sm">{order.supplier.name}</span>
                      </div>

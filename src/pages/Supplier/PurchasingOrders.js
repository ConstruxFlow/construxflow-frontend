        ...
        <div className="flex items-center justify-center h-96">
          <div className="text-center">
            ...
            <button
              ...
              className="px-4 py-2 bg-web_yellow text-main_dark rounded-lg hover:bg-web_yellow/90 font-semibold transition-colors"
            >
              Retry
            </button>
          </div>
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6 gap-4">
            <div>
              ...
              <p className="text-gray-600 text-sm sm:text-base">
                Track and manage all purchase orders received from buyers
              </p>
            </div>
            ...
            {filteredOrders.length === 0 ? (
              ...
              <>
                ...
                <div className="lg:hidden divide-y divide-gray-200">
                  {paginatedOrders.map((order, idx) => (
                    <div key={order.poId || idx} className="p-4">

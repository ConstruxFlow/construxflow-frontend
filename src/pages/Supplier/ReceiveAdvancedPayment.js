// src/pages/Supplier/ReceiveAdvancedPayment.jsx
...
const payment = {
  ...
  instructions:
    "This advanced payment covers 50% of Order ORD-2024-5678 for construction materials delivery. Please confirm receipt within 24 hours. The remaining balance will be processed upon delivery completion.",
};

const statusBadge = {
  "Pending Confirmation": "bg-slatebluegray text-purewhite",
  Confirmed: "bg-deep_green text-purewhite",
};
  ...
  <div className="bg-purewhite min-h-screen font-poppins">
    ...
    <div className="max-w-full mx-auto px-16 py-10">
      ...
      <p className="text-gray-600 mb-8">
        Review and confirm receipt of your advanced payment
      </p>

      {/* Payment Summary Card */}
      <div className="bg-gray-200 rounded-xl p-7 mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-8">
        <div className="flex-1">
          ...
          <div className="mb-2 flex items-center gap-2">
            ...
            <span className="font-medium text-main_dark ml-2">{payment.date}</span>
          </div>
        </div>
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 text-sm">
        <div>
          <div className="font-bold mb-2 flex items-center gap-2">
            <span className="bg-web_yellow w-6 h-6 rounded flex items-center justify-center text-main_dark font-bold text-lg">S</span>
            SupplyChain
          </div>
